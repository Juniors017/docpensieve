...
<Skill name="npm publishing" level={40} shape="circle">
  The token is still to be set.
</Skill>
...
`icon` goes before the name — a [LogoIcon](/components/logo-icon/) fits there.
  ...
  <Column span={6}>
    <Card className="h-full">
      ...
      <CardBody>
        ...
        <Skill name="npm publishing" level={40}>
          The token is still to be set.
        </Skill>
