...
To try the beta — the 0.2 — install `docpensieve@beta`, or run
`npx docpensieve@beta` alone. [Migrate from latest to beta](./migrate-to-beta/)
says what changes, and what to check first.
