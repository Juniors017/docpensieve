...
tool, the mark of a team. It names an SVG of the version folder, inlined at the
build like any other icon:
...
A file that does not exist stops the build, naming the path it looked for.
