...
Rien pour l'instant : la 0.5 vient de s'ouvrir. Chaque nouveauté sera listée
ici à son arrivée, à côté de ce qu'elle demande à un projet déjà bâti sur la
0.4.

## Pour un projet en 0.4

Rien à changer : une configuration 0.4 se génère telle quelle.
