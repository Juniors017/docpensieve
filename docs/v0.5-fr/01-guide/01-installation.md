...
Venant de la 0.4, [Migrer vers la bêta](./migrate-to-beta/) dit ce qui change
tout seul et ce qu'il faut vérifier. Pour essayer cette bêta, installez
`docpensieve@beta`, ou lancez `npx docpensieve@beta` seul.
